...
class sale_extended_fields(models.Model):
    ...
    donor1_sample_collector = fields.Many2one('res.users', string='Người thu mẫu', default=lambda  self: self.env.user)
    ...
    donor2_sample_collector = fields.Many2one('res.users', string='Người thu mẫu', default=lambda  self: self.env.user)
    ...
    donor3_sample_collector = fields.Many2one('res.users', string='Người thu mẫu', default=lambda  self: self.env.user)
